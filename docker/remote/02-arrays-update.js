/**
 * @file BRI Remote Examples: Array operations, updates, and replacements
...
/**
 * Run array and update examples over remote connection
...
export async function runArrayUpdateExamples(db, entities) {
  const { alice, bob, charlie, diana, eve, frank } = entities;
